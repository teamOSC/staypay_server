...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appliances.hotel_id'
        db.add_column(u'hotel_appliances', 'hotel_id',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appliances.hotel_id'
        db.delete_column(u'hotel_appliances', 'hotel_id')
